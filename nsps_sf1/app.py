...
from publisher1 import send_account, send_account_update, send_account_delete
...
def delete(account_id):
    ...
    if not acc:
        return "Account not found <br><a href='/'>Back</a>", 404
    # Publish DELETE so the other system (NPC_SF2) removes it too
